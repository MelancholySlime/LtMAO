...
class Interactor:
    ...
    @typing.overload
    def add_binding(self, bind: InteractionBind, command: str, group: str, documentationCallback: typing.Callable[[], tuple[str, str]]=None, type: Interactor.BindingType=Interactor.BindingType.OTHER, notify: bool=True) -> Interactor:
        """
        Add a binding command
        """

    @typing.overload
    def add_binding(self, bind: InteractionBind, command: collections.abc.Sequence[str], group: str, documentationCallback: typing.Callable[[], tuple[str, str]]=None, type: Interactor.BindingType=Interactor.BindingType.OTHER, notify: bool=True) -> Interactor:
        """
    ...
    def trigger_notification(self, desc: str, value: str='', duration: float=3.0) -> Interactor:
        """
...
class Scene:
    ...
    @typing.overload
    def add(self, buffer: bytes) -> None:
        """
        Add a memory buffer containing a file the scene
        """
    ...
    @typing.overload
    def add(self, buffer: bytes, size: int) -> None:
        """
        Add a memory buffer containing a file the scene
        """
    ...
    def get_animation_name(self, index: int=-1) -> str:
        """
